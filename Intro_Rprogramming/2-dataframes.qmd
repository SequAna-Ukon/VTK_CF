...
-   Functions `complete.cases` and `na.omit` for removing observations with missing values:
...
-   I really recommend to have a look at [dplyr](https://dplyr.tidyverse.org/) R package. It is a grammar of data manipulation, providing a consistent set of verbs that help you solve the most common data manipulation challenges.
